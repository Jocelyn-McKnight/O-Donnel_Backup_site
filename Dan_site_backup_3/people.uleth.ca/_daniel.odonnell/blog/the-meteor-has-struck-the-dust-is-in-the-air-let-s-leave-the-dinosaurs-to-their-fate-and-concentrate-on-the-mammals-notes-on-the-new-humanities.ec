...
<!-- Mirrored from people.uleth.ca/~daniel.odonnell/blog/the-meteor-has-struck-the-dust-is-in-the-air-let-s-leave-the-dinosaurs-to-their-fate-and-concentrate-on-the-mammals-notes-on-the-new-humanities by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 09 Dec 2024 06:21:42 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=utf-8" /><!-- /Added by HTTrack -->
<head>
		<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<meta name="google-site-verification" content="9ZHP1FDttD1YeXYP4jrDb8KmwNTGqQgRb92Y1B3M_Ro" />
		<title>
			The meteor has struck. The dust is in the air. Let&#39;s leave the dinosaurs to their fate and concentrate on the mammals: Notes on the New Humanities. | Daniel Paul O&#039;Donnell
		</title>
...
<h2>The meteor has struck. The dust is in the air. Let&#39;s leave the dinosaurs to their fate and concentrate on the mammals: Notes on the New Humanities.</h2>
...
<p>Posted: Apr 05, 2013 12:04;<br/>Last Modified: May 17, 2013 15:05<br/>
...
<!-- automatic TOC ends -->
	<p><em>The abstract for my talk tomorrow at</em> <a href="http://diggingdigital2013.wordpress.com/conference-programme-2-2/">Digging the Digital 2013</a> <em>in at the University of Alberta in Edmonton tomorrow.</em> (Slides are now available here: <a href="http://ubuntuone.com/6bIDLtwEOWDhBDDxb8ImZy">http://ubuntuone.com/6bIDLtwEOWDhBDDxb8ImZy</a></p>

	<blockquote>
		<p>The digital humanities are not some flashy new theory that might go out of fashion. At this point, the digital humanities are The Thing.  There’s no Next about it. And it won’t be long until the digital humanities are, quite simply, “the humanities” (Pannapacker 2011).</p>
	</blockquote>

	<p>It is a truism to note that the definition and scope of the Digital Humanities has been the object of considerable discussion in recent years. Who&#8217;s in? Who&#8217;s out? Do you have to code? Must you read from a distance? Is DH under theorised? Overly popular with funders? A threat or an opportunity to renew the “old” humanities?</p>

	<p>In my view, this focus on DH as a (sub-)discipline of the larger Humanities is unfortunate. Because while I have gradually come to believe that there is such a thing as the Digital Humanities (in the same way that there are other (sub-)disciplinary specialisations like Post-Colonial Theory or Medieval Studies), I have also come to believe that our focus on defining what makes it different is preventing us from paying attention to what is really important about the widespread introduction of computation into humanistic study over the last few years: the extent to which technology is changing the way we do everything else.</p>

	<p>In this paper, I would like to look at how digital technologies are fundamentally changing the way Humanists—of all persuasions and sub-disciplines—are conducting their day-to-day business. How they are changing the way we teach, the way we communicate, interact with colleagues and the public, and judge our relative success. In many cases, these changes are so new that our discipline as a whole has, by-and-large, yet to grasp fully the extent to which they have already occurred. In other cases, our ability to benefit from changes that have been recognised is hindered by generational resistance, institutional inertia, and a tendency to see anything digital as belonging to the DH “fad.” </p>

	<p>This is a problem we must address. An Open Access, Open Source, social web is an internet that presents Humanists of all stripes with remarkable opportunities: to engage with far larger audiences, to work with a far wider variety of cultural and historical material, and to develop forms of communication and publication that are far better suited to the type of research and teaching we have always done. Our unwillingness to embrace more fully the opportunities before us and develop the skills and knowledge necessary to lead in their development is a terrible missed opportunity.</p>

	<p>As my title suggests, I also believe it is a generational problem: the technology that offers us the greatest opportunities has developed far faster than we have been able to integrate it into our disciplinary training. Few Associate Professors have PhDs that are newer than the popular recognition of the most significant Web 2.0 applications; many of our senior faculty began graduate school before the development of the World Wide Web. The only way forward, I argue, is for the dinosaurs to recognise that their days are numbered and to develop a new training model that prepares our students for the mammalian world they are going to inherit. </p>
<!-- <img src="https://people.uleth.ca/~daniel.odonnell/images/1.gif" width="400" height="1" class="divider" alt="---" title="Section separator" />
<p>Posted: Friday April  5, 2013. 12:50.</p> 
<p>Last modified: Friday May 17, 2013. 15:41.</p> -->
<div class="comments">
...
<form id="txpCommentInputForm" method="post" action="https://people.uleth.ca/~daniel.odonnell/blog/the-meteor-has-struck-the-dust-is-in-the-air-let-s-leave-the-dinosaurs-to-their-fate-and-concentrate-on-the-mammals-notes-on-the-new-humanities#cpreview">
...
<input name="parentid" type="hidden" value="242" />

<input name="backpage" type="hidden" value="/~daniel.odonnell/blog/the-meteor-has-struck-the-dust-is-in-the-air-let-s-leave-the-dinosaurs-to-their-fate-and-concentrate-on-the-mammals-notes-on-the-new-humanities" />
</div>
</form>
